...
public enum SpecialityActions {
    ...
    ELF_S1_A4("Dispell ",
            20, 0, 0, 10, 3,
            "Dispells any spell on choosen target"),
    ELF_S1_A5("Stone Gaze",
            45, 0, 3, 10, 3,
            "Ransform enemy into stone for 2 turns"),
...
/**/    ELF_S2_A4("RapidFire",
    ...
    ELF_S2_A5("BullsEye",
            40, 0, 3, 10, 3,
            "archer takes aim and deal crit damage to sinle target 3d10, cd 3 turns"),
...
/**/    HUMAN_S1_A4("Hand of God",
    ...
    DWARF_S2_A2("Bombs!",
            0, 25, 2, 6, 2,
            "throw a bomb that hits 2 enemys and deal 2d6 dmg to each, cd 2 turns"),
